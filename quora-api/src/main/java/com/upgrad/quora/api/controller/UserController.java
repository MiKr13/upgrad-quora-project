...
public class UserController {
    // Required services are autowired to enable access to methods defined in
    // respective Business services
    @Autowired
    private AuthenticationService authenticationService;

    /**
     * @param signupUserRequest the first {@code SignupUserRequest} to signup a
     *                          particular user with details.
    ...
    public ResponseEntity<SignupUserResponse> signup(final SignupUserRequest signupUserRequest)
        ...
        final UserEntity createdUserEntity = authenticationService.signup(userEntity);
    ...
    /**
     * @param authorization the first {@code String} to signin a particular user and
     *                      check access.
    ...
    public ResponseEntity<SigninResponse> login(@RequestHeader("authorization") final String authorization)
        ...
        UserAuthTokenEntity userAuthToken = authenticationService.authenticate(authArray[0], authArray[1]);
    ...
    public ResponseEntity<SignoutResponse> loginOut(@RequestHeader("authorization") final String accessToken)
        ...
        UserAuthTokenEntity userAuthToken = authenticationService.signOutService(bearerToken);
